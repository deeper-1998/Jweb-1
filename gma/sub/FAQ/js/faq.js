...
function menuHover() {   //메뉴박스 drop Down
    ...
    if (gnb[0].style.height == "275px") {
        console.log("hg");
        bg[0].style.background = "linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(./images/Gyeonggi_Museum_5.jpg)"
...
function menuLeave() {   //메뉴박스 drop Up
    ...
    if (gnb[0].style.height == "70px") {
        console.log("hg");
        bg[0].style.background = "linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(./images/Gyeonggi_Museum_5.jpg)"
        bg[0].style.backgroundPosition = "center top"
        bg[0].style.backgroundSize = "cover"
